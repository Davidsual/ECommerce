...
{
    public partial class Viaggiare_con_Animali : BasePage, IPerbaffoSite
    {
        ...
        {
            this.Header1.AggiornaLink(Perbaffo.Web.UI.Header.SezioniHeader.Viaggiare);
            if (!Page.IsPostBack)
            {
        ...
        {
            this.TitoloPagina = "Viaggiare con animali";
            this.DescrizionePagina = "Tutte le informazioni, prodotti e accessori utili per viaggiare con il proprio amico";
            this.KeywordsPagina = "Perbaffo,viaggiare,animali,amici,informazioni,categorie,cani,gatti,roditori,volatili,terrari";
        }
        #endregion
    }
}
