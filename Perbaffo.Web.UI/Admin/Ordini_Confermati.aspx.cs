...
{
    public partial class Ordini_Confermati : BasePage
    {
        ...
        protected void grdListProdotti_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                e.Row.BackColor = Color.FromName("#FFFF66");
        ...
        private void PopulateDataSource(int page, int pageSize)
        {
            ...
            this.grdListProdotti.DataSource = this.PerbaffoController.GetOrdiniConfermati(_startRecord, pageSize);
            this.grdListProdotti.DataBind();
            this.TotOrdini = this.PerbaffoController.GetCountOrdiniConfermati();
