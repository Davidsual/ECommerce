<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ordini.aspx.cs" MasterPageFile="PerbaffoMaster.master"
    Inherits="Perbaffo.Web.UI.Admin.Ordini" %>
                ...
                <asp:GridView ID="grdListProdotti" runat="server" AutoGenerateColumns="False" BorderColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Totale">
                            <ItemTemplate>
                                €&nbsp;<span id="lblTotaleOrdine" runat="server"></span>
                            </ItemTemplate>
                        </asp:TemplateField>                        
                    </Columns>
