...
{
    public partial class GestioneOfferte : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                this.TotProdotti = this.PerbaffoController.GetCountProdottiOfferte(true);
        ...
        private void PopulateDataSource(int page, int pageSize)
        {
            ...
            this.grdListProdotti.DataSource = this.PerbaffoController.GetProdottiOffertePaging(true,_startRecord, pageSize);
