<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="PerbaffoMaster.Master" CodeBehind="GestioneProdottiSottoScorta.aspx.cs" Inherits="Perbaffo.Web.UI.Admin.GestioneProdottiSottoScorta" %>
        ...
        <ContentTemplate>
            ...
            <center>
                <asp:GridView ID="grdListProdotti" runat="server" AutoGenerateColumns="False" BorderColor="White"
                    ...
                    CellSpacing="2" 
                    EmptyDataText="&lt;p&gt;&lt;b&gt;Non ci sono prodotti sotto scorta&lt;/b&gt;&lt;/p&gt;" 
            ...
            <userControl:Pager ID="Pager" runat="server" Separator=" | " FirstText="Primo" PreviousText="<"
                NextText=">" LastText="Ultimo" PageSize="10" NumberOfPages="6" ShowGoTo="True"
