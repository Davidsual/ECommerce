<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="PerbaffoMaster.Master" CodeBehind="GestioneSpedizioni.aspx.cs" Inherits="Perbaffo.Web.UI.Admin.GestioneSpedizioni" %>
...
<script language="javascript" type="text/javascript">
    function fCheckValue() {
        ...
        if (field != null) {
            if (!field.checked)
                return confirm("Stai disattivando questa modalità di spedizione, sei sicuro?");
        }
        return true;
    }
</script>
            ...
            <table border="0" align="center" style="font-size: 10px; font-family: Verdana; font-weight: bold">
                <tr>
                    ...
                    <div style="width:640px;height:200px;overflow-y:scroll">
                        ...
                        <asp:GridView ID="grdListaSpedizione" runat="server" 
                            AutoGenerateColumns="False" BorderColor="White"
                            CellPadding="4" ForeColor="#333333" GridLines="None" CellSpacing="2" 
                            EmptyDataText="<p><b>Nessuna spedizione censita</b></p>" 
                            AutoGenerateSelectButton="True" 
                            onselectedindexchanged="grdListaSpedizione_SelectedIndexChanged">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Descrizione" DataField="DescrBreveSpedizione" />
                                <asp:BoundField HeaderText="Costo" DataField="CostoSpedizione" />
            ...
            <table border="0" align="center" style="font-size: 10px; font-family: Verdana; font-weight: bold">
                <tr>
                    <td width="50%" align="right">
                        Tipo Spedizione (Breve)</td>
                    <td width="50%" align="left">
                        <asp:TextBox ID="txtDescrSpedizione" runat="server" Width="221px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td width="50%" align="right">
                        Tipo Spedizione (Estesa)</td>
                    <td width="50%" align="left">
                        <asp:TextBox ID="txtDescrSpedizioneLunga" runat="server" Width="221px" 
                ...
                <tr>
                    ...
                    <asp:Button ID="btnDelete" runat="server" Text="Cancella" OnClientClick="return confirm('Attenzione stai per cancellare in maniera definitiva questo tipo di spedizione, se questo è legato a qualche ordine non sarà possibile cancellarlo. Continuare?');"
