<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="PerbaffoMaster.Master"
    CodeBehind="CodiciPromozioni.aspx.cs" Inherits="Perbaffo.Web.UI.Admin.CodiciPromozioni" %>
        ...
        <ContentTemplate>
            ...
            <center>
                ...
                <table border="0" width="100%">
                    <tr>
                        <td align="center">
                            <a href="DettaglioCodiciPromozioni.aspx" style="font-size: 10px; font-family: Verdana; font-weight: normal">
                                <img border="0" src="img/filenew.gif"><br />
                                    Aggiungi un codice promozione<br />
                                </img>
                            </a>
                        </td>
                    </tr>
