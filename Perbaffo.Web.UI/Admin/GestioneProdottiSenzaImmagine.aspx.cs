...
{
    public partial class GestioneProdottiSenzaImmagine : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                this.TotProdotti = this.PerbaffoController.GetCountProdottiSenzaImmagini();
        ...
        private void PopulateDataSource(int page, int pageSize)
        {
            ...
            this.grdListProdotti.DataSource = this.PerbaffoController.GetProdottiSenzaImmagini(_startRecord, pageSize);
