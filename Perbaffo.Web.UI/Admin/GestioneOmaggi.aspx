<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="PerbaffoMaster.Master" CodeBehind="GestioneOmaggi.aspx.cs" Inherits="Perbaffo.Web.UI.Admin.GestioneOmaggi" %>
        ...
        <ContentTemplate>
            ...
            <center>
                <asp:GridView ID="grdListProdotti" runat="server" AutoGenerateColumns="False" BorderColor="White"
                    ...
                    CellSpacing="2" 
                    EmptyDataText="&lt;p&gt;&lt;b&gt;Non ci sono prodotti contrassegnati come omaggi&lt;/b&gt;&lt;/p&gt;" 
                    ...
                    <asp:BoundField HeaderText="Ordini a partire da:" DataField="RangeOmaggio" />
