...
{
    public partial class CodiciPromozioni : BasePage
    {
        ...
        protected void grdListProdotti_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                string _param = "?IDCodicePromozione=" + _idCodice;
                ((PerbaffoMaster)this.Master).LoadPage(PerbaffoMaster.SectionMaster.CodicePromozione, _param);
                return;
            }
        }
        /// <summary>
