<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="PerbaffoMaster.Master"
    CodeBehind="DettaglioCodiciPromozioni.aspx.cs" Inherits="Perbaffo.Web.UI.Admin.DettaglioCodiciPromozioni" %>
                    ...
                    <table border="0" width="100%" style="font-family: Verdana; font-size: 16pt; font-weight: bold;
                        ...
                        <tr>
                            <td align="left" valign="middle" style="color: #3366CC">
                                Gestione Codici Promozioni Inserisci/Modifica/Cancella
                            </td>
                ...
                <table border="0" cellpadding="1" cellspacing="2" align="center" style="font-size: 10px;
                    ...
                    <tr>
                        <td width="30%" align="right">
                            Codice Promozione (max 10 crt.):
                        </td>
                        <td width="70%" align="left">
                            <asp:TextBox ID="txtCodicePromozione" runat="server" MaxLength="10" Width="100px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCodicePromozione"
                                Text="!" ErrorMessage="Codice Promozione obbligatorio" ValidationGroup="Prodotto"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
