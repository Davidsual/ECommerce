<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="PerbaffoMaster.Master"
    CodeBehind="OrdiniAffiliazione.aspx.cs" Inherits="Perbaffo.Web.UI.Admin.OrdiniAffiliazione" %>
        ...
        <ContentTemplate>
            ...
            <center>
                <asp:GridView ID="grdListProdotti" runat="server" AutoGenerateColumns="False" BorderColor="White"
                    ...
                    EmptyDataText="&lt;p&gt;&lt;b&gt;Non ci sono Ordini - affiliazione&lt;/b&gt;&lt;/p&gt;" 
                    PageSize="20">
                    <RowStyle BackColor="#EFF3FB" />
                    <Columns>
                    <asp:BoundField HeaderText="Sito" DataField="Sito" />
                    <asp:BoundField HeaderText="Cod Ordine" DataField="CodOrdine" />
                    <asp:BoundField HeaderText="Data Ordine" DataField="DataOrdine" />
                    </Columns>
