<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="PerbaffoMaster.master" CodeBehind="Ordini_Confermati.aspx.cs" Inherits="Perbaffo.Web.UI.Admin.Ordini_Confermati" %>
            ...
            <table border="0" width="100%" style="font-family: Verdana; font-size: 16pt; font-weight: bold;">
                        ...
                        <table border="0" width="100%" style="font-family: Verdana; font-size: 16pt; font-weight: bold;
                            ...
                            <tr>
                                <td align="left" valign="middle" style="color: #3366CC">
                                    Gestione Ordini Confermati (ovvero Pagati)
                                </td>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td><a href="Ordini_Spediti.aspx" style="font-size: 8pt; font-weight: normal">Ordini Spediti</a></td>
