...
{
    public partial class Promozioni_Gatti : BasePage, IPerbaffoSite
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                this.TotProdotti = this.PerbaffoController.GetCoutProdottiPromozioniGatti();
        ...
        {
            this.TitoloPagina = "Articoli e accessori in promozione per gatti";
            this.DescrizionePagina = "Perbaffo tutti i prodotti e gli accessori in promozione per la categoria gatti";
            this.KeywordsPagina = "Perbaffo,prodotti,accessori,articoli,omaggio,categoria,ordine,promozioni,costo,scontato,gatti,promozione,roditori,prodotto,acquariologia,terrari,prezzo";
        }
        /// <summary>
        /// Carica la griglia
        /// </summary>
        ...
        private void PopulateDataSource(int page, int pageSize)
        {
            ...
            this.rptOfferte.DataSource = this.PerbaffoController.GetProdottiPromozioniGatti(_startRecord, pageSize);
