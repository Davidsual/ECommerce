<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prodotti-Novita.aspx.cs"
    Inherits="Perbaffo.Web.UI.Prodotti_Novita" %>
                            ...
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0" style="width: 100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <span class="med_text_dodici" style="color:Black;clear: both;">In questa categoria, trovi gli ultimi 20 prodotti e accessori per animali inseriti su Perbaffo
                                                </span>         
                                                <asp:UpdatePanel ID="updPnlNovita" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                    <br />
                                                        <asp:Repeater ID="rptNovita" runat="server" OnItemDataBound="rptNovita_ItemDataBound"
                                                            OnItemCommand="rptNovita_ItemCommand">
                                                            <ItemTemplate>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top" align="center" style="width: 100px;">
                                                                                                <a href='Dettaglio-Prodotto.aspx?Prodotto=<%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).ID%>'
                                                                                                    title="">
                                                                                                    <img src='<%= UrlImmagine %><%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).UrlImmagine%>'
                                                                                                        alt="<%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).DescrImmagine%>"
                                                                                                        title="<%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).DescrImmagine%>"
                                                                                            ...
                                                                                            <td valign="top" align="left">
                                                                                                <a href='Dettaglio-Prodotto.aspx?Prodotto=<%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).ID%>'
                                                                                                    title="<%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).Nome%>"
                                                                                                    style="text-decoration: none;"><span class="med_text"><b>
                                                                                                        <%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).Nome%></b></span></a>
                                                                                                <br />
                                                                                                ...
                                                                                                <span class="small_text" style="display: block;">
                                                                                                    <%# TagliaStringa(((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).DescrizioneLunga)%></span>                                                                                                
                                                                                                <span class="small_text" style="margin-top: 10px;" runat="server" id="lblMisuraStandard"><b>Misura:</b>
                                                                                                    <%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).DescrTaglia %></span>
                                                                                                <br />
                                                                                                <table cellpadding="0" cellspacing="0" width="50%" style="margin-top: 10px; margin-bottom: 6px;
                                                                                                    border-color: black; border-width: 1px; border-style: solid; display: <%# IsOfferta(((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).Prezzo,((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).Totale)%>;">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                            ...
                                                                                                            <td align="right">
                                                                                                                <span class="price_large_black" style="text-decoration: line-through;">€
                                                                                                                    <%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).Prezzo%></span>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                            ...
                                                                                                            <td align="right">
                                                                                                                <span class="price_large">€
                                                                                                                    <%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).Totale%></span>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                                <table cellpadding="0" cellspacing="0" width="50%" style="margin-top: 10px; margin-bottom: 6px;
                                                                                                    border-color: #90989a; border-width: 1px; border-style: solid; display: <%# IsNotOfferta(((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).Prezzo,((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).Totale)%>;">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <span class="small_text"><b>Prezzo:&nbsp;</b></span>
                                                                                                ...
                                                                                                <span class="small_text">(Inserito il:
                                                                                                    <%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).DataInserimento.Value.ToShortDateString() %>)</span><br />
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td bgcolor="#f5f5f5" valign="middle" align="center">
                                                                                                                <asp:Button class="standardsubmit" ID="btnAcquista" CommandName="ACQUISTA" runat="server"
                                                                                                                    CommandArgument="<%#((Perbaffo.Presenter.Model.ProdottoNovita)Container.DataItem).ID%>"
