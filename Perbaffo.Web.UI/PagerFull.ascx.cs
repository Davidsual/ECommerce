//-----------------------------------------------------------------------
// <copyright file="Pager.ascx.cs" company="Thap Ltd">
//     Copyright (c) Thap Ltd. All rights reserved.
// </copyright>
// <author>Tony Williams</author>
//-----------------------------------------------------------------------
namespace Perbaffo.Web.UI
{
    ...
    public class PagerFullEventArgs : EventArgs
    {
    ...
    public partial class PagerFull : BasePageUserControl
    {
        #region Events
        /// <summary>Fires when a  link is clicked, the text with in the object (link button) is the number</summary>
        public event EventHandler<PagerFullEventArgs> Change;
        #endregion
        ...
        #region EVENTS
        /// <summary>
        /// Generazioen dei link
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void RepeaterNumbers_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                HyperLink _href = e.Item.FindControl("lnkPagina") as HyperLink;
                if (_href != null && e.Item.DataItem != null)
                {
                    if ((int)e.Item.DataItem == this.CurrentPageNumber)
                    {
                        _href.Style.Add("color", "black");
                        _href.Style.Add("text-decoration", "none");
                        _href.Style.Add("cursor", "default");
                        _href.NavigateUrl = "javascript:void(0);";
                    }
                    else
                    {
                        _href.Style.Remove("color");
                        _href.NavigateUrl = this.GetUrl(e.Item.DataItem.ToString());
                    }
                }
        ...
        public void GenerateLinks()
        {
            ...
            {
                this.LinkButtonFirst.Style.Add("color", "black");
                this.LinkButtonFirst.Style.Add("text-decoration", "none");
                this.LinkButtonFirst.Style.Add("cursor", "default");
                this.LinkButtonFirst.NavigateUrl = "javascript:void(0);";

                this.LinkButtonPrevious.Style.Add("color", "black");
                this.LinkButtonPrevious.Style.Add("text-decoration", "none");
                this.LinkButtonPrevious.Style.Add("cursor", "default");
                this.LinkButtonPrevious.NavigateUrl = "javascript:void(0);";
            }
            else
            {
                this.LinkButtonFirst.NavigateUrl = this.GetUrl("1");
                this.LinkButtonPrevious.NavigateUrl = this.GetUrl((this.CurrentPageNumber - 1).ToString());
            }
            if (this.CurrentPageNumber >= this.TotalPages)
            {
                this.LinkButtonNext.Style.Add("color", "black");
                this.LinkButtonNext.Style.Add("text-decoration", "none");
                this.LinkButtonNext.Style.Add("cursor", "default");
                this.LinkButtonNext.NavigateUrl = "javascript:void(0);";

                this.LinkButtonLast.Style.Add("color", "black");
                this.LinkButtonLast.Style.Add("text-decoration", "none");
                this.LinkButtonLast.Style.Add("cursor", "default");
                this.LinkButtonLast.NavigateUrl = "javascript:void(0);";
            }
            else
            {
                this.LinkButtonNext.NavigateUrl = this.GetUrl((this.CurrentPageNumber + 1).ToString());
                this.LinkButtonLast.NavigateUrl = this.GetUrl(this.TotalPages.ToString());
            }
            ///Primo url
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                this.LinkButtonFirst.ToolTip = "Torna alla prima pagina";
                ...
                this.LinkButtonLast.ToolTip = "Vai all'ultima pagina";
        ...
        //        var args = new PagerFullEventArgs
        //                       {
        //                           First = true, 
        //                           Previous = false, 
        //                           Next = false, 
        ...
        /// <summary>
        /// Ottiene l'url da mettere sul link della pagina
        /// </summary>
        /// <param name="currentPage"></param>
        /// <returns></returns>
        private string GetUrl(string currentPage)
        {
            string url = Request.Url.ToString().Replace("amp;", string.Empty);
            if (url.Contains("Page="))
            {
                
                if (url.IndexOf("&Page=") == -1)
                    return url.Substring(0, url.IndexOf("?Page=")) + "?Page=" + currentPage;
                else
                    return url.Substring(0, url.IndexOf("&Page=")) + "&Page=" + currentPage;
            }
            else
