...
namespace Perbaffo.Web.UI
{
    ...
    public partial class Pager : BasePageUserControl
    {
        #region Events
        ...
        protected void RepeaterNumbers_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                LinkButton _lnk = e.Item.FindControl("LinkButtonNumber") as LinkButton;
                if (_lnk != null && e.Item.DataItem != null)
                {
