<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prodotti-Omaggio.aspx.cs" Inherits="Perbaffo.Web.UI.Prodotti_Omaggio" %>
                            ...
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0" style="width: 100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <span class="med_text_dodici" style="color:Black;clear: both;">Qui puoi trovare i prodotti e gli accessori per animali che puoi scegliere come omaggio alla fine di ogni ordine.</span>                                               
                                                <asp:UpdatePanel ID="updPnlOmaggio" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:Repeater ID="rptOmaggio" runat="server">
                                                            <ItemTemplate>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td valign="top" align="left">
                                                                                                <a href="#" title="<%#((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).Nome%>" style="text-decoration:none;"><span class="med_text">
                                                                                                    <b>
                                                                                                ...
                                                                                                <span class="small_text" style="display:block;">
                                                                                                 ...
                                                                                                 <span class="small_text" style="font-family: Verdana, sans-serif, arial,helvettica;margin-top:10px;"><b>Misura:</b> <%#((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).DescrTaglia %></span>
                                                                                                    <br />
                                                                                                    <span style="color: black;margin-right:10px;font-size: 12px;background-color:Yellow;"><b>Prodotto in omaggio per acquisti superiori a:</b></span>
                                                                                                <span style="font-family: Verdana, sans-serif, arial,helvettica;color: #ad0e2a;font-size: 12px;"><b>€ <%#((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).RangeOmaggio%></b></span>
                                                                                                <br />
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
