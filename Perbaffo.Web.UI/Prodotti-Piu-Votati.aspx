<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prodotti-Piu-Votati.aspx.cs"
    Inherits="Perbaffo.Web.UI.Prodotto_Piu_Votati" %>
                            ...
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0" style="width: 100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <span class="med_text_dodici" style="color:Black;clear: both;">In questa categoria, puoi trovare tutti gli articoli e accessori per animali più votati e recensiti dagli utenti di Perbaffo.
                                                Se ti sei trovato bene o male con un prodotto scrivi la tua recensione nel dettaglio del prodotto in modo da consigliare gli altri utenti sull'acquisto.</span>                                             
                                                <asp:UpdatePanel ID="updPnlPiuVotati" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top" align="center" style="width: 100px;">
                                                                                                <div id="divVoto" runat="server"></div>
                                                                                                <a href='Dettaglio-Prodotto.aspx?Prodotto=<%#((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).ID%>'
                                                                                                    ...
                                                                                                    <img src='<%= UrlImmagine %><%#((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).UrlImmagine%>'
                                                                                                        alt='<%#((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).DescrImmagine%>' title='<%#((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).DescrImmagine%>'
                                                                                            ...
                                                                                            <td valign="top" align="left">
                                                                                                ...
                                                                                                <table cellpadding="0" cellspacing="0" width="50%" style="margin-top: 10px; margin-bottom: 6px;
                                                                                                    border-color: black; border-width: 1px; border-style: solid; display: <%# IsOfferta(((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).Prezzo,((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).Totale)%>;">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                ...
                                                                                                <table cellpadding="0" cellspacing="0" width="50%" style="margin-top: 10px; margin-bottom: 6px;
                                                                                                    border-color: #90989a; border-width: 1px; border-style: solid; display: <%# IsNotOfferta(((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).Prezzo,((Perbaffo.Presenter.Model.ProdottoImmagine)Container.DataItem).Totale)%>;">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <span class="small_text"><b>Prezzo:</b></span>
