<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Promozioni-Gatti.aspx.cs" Inherits="Perbaffo.Web.UI.Promozioni_Gatti" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center" valign="top">
                                                <span class="med_text_dodici" style="color:Black;clear: both;">In questa categoria, puoi trovare tutti gli articoli e accessori per gatti in promozione e scontati.
                                                Dalle cucce per gatti ai tiragraffi per gatti sino agli articoli da viaggio,collari e igene per il nostro gatto</span>                                            
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td valign="top" align="left">
                                                                                                ...
                                                                                                <HeaderTemplate>
                                                                                                <br />
                                                                                                <span class="small_text">Altre taglie disponibili:</span>
                                                                                                </HeaderTemplate>
                                                                                                <ItemTemplate>
